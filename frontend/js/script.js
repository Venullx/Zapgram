...
function createReactionIcon(messageDiv) {
    ...
    reactionList.style.display = 'flex'; // Usando flex para melhor alinhamento
...
const observer = new MutationObserver(() => {
    const messageDivs = document.querySelectorAll('.chat__messages .message--other, .chat__messages .message--self');
